...
const FULL_FEEDS: Record<string, Feed[]> = {
  ...
  latam: [
    ...
    { name: 'Reforma', url: rss('https://news.google.com/rss/search?q=site:reforma.com+when:2d&hl=es&gl=MX&ceid=MX:es'), lang: 'es' },
    { name: 'El Financiero', url: rss('https://www.elfinanciero.com.mx/arc/outboundfeeds/rss/'), lang: 'es' },
    { name: 'Milenio', url: rss('https://www.milenio.com/rss/home'), lang: 'es' },
    { name: 'Proceso', url: rss('https://www.proceso.com.mx/rss'), lang: 'es' },
    { name: 'Animal Político', url: rss('https://www.animalpolitico.com/feed/'), lang: 'es' },
